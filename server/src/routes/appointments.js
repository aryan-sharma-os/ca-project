...
import { createAppointment, listMyAppointments, updateAppointment, cancelAppointment, validateCreate, validateUpdate, approveAppointment, rejectAppointment, rescheduleAppointment, validateReschedule } from '../controllers/appointmentController.js';
